...
import {ArrowLeft, Target, TrendingUp, BarChart3, Activity, Cpu} from 'lucide-react';
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {runData?.data?.metrics?.train_accuracy && (
                        <div
                            className="bg-gray-800/50 border border-green-500/40 rounded-lg p-4 hover:border-green-400/60 transition-colors">
                    ...
                    {runData?.data?.metrics?.train_loss && (
                        <div
                            className="bg-gray-800/50 border border-red-500/40 rounded-lg p-4 hover:border-red-400/60 transition-colors">
                            <div className="flex items-center justify-between mb-2">
                    ...
                    {runData?.data?.params?.epochs && (
                        <div
                            className="bg-gray-800/50 border border-blue-500/40 rounded-lg p-4 hover:border-blue-400/60 transition-colors">
                            <div className="flex items-center justify-between mb-2">
                    ...
                    {runData?.data?.params?.learning_rate && (
                        <div
                            className="bg-gray-800/50 border border-purple-500/40 rounded-lg p-4 hover:border-purple-400/60 transition-colors">
                            <div className="flex items-center justify-between mb-2">
                ...
                {Object.keys(groupedMetrics).length > 0 && (
                    <div className="space-y-6">
                        ...
                        {Object.entries(groupedMetrics).map(([metricName, metricHistory]) => (
                            <div key={metricName} className="bg-gray-800/50 border border-cyan-500/40 rounded-lg p-6">
                ...
                {/* Parameters Section */}
                <div className="bg-gray-800/50 border border-cyan-500/40 rounded-lg p-6">
